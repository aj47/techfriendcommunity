// Vendored from https://github.com/GoogleChromeLabs/webmcp-tools (demos/shared/webmcp-polyfill.js)
// Loaded only when the browser has no native document.modelContext.
/**
